...
// const Header = () => {
//   return (
//     <div className='py-7 px-10 bg-emerald-600 text-white flex items-center justify-between'>Header
//         <h2 className='text-2xl'>sheryians<input className='text=black'></input></h2>
